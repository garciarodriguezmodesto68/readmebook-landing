...
export default function WelcomePage() {
  ...
  return (
    <main className="bg-[#F4F1EA] text-[#2B1712] min-h-screen flex flex-col justify-between overflow-hidden">
      ...
      <section className="flex-grow flex items-center justify-center px-6 pt-32 pb-12">
        ...
        >
          ...
          <h1 className="text-4xl lg:text-5xl font-bold leading-tight mb-6 tracking-tight">
            {t.welcome_title}
            <br />
            <span className="text-[#A17808]">
              {t.welcome_title_highlight}
            </span>
          </h1>
